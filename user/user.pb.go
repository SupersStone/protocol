...
type SortQueryReq struct {
	...
	UserIDName map[string]string `protobuf:"bytes,2,rep,name=userIDName,proto3" json:"userIDName,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func file_user_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_user_user_proto_msgTypes[43].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetUserOnlineStatusResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_user_user_proto_msgTypes[67].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllOnlineUsersReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_user_user_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllOnlineUsersResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
func (c *userClient) SortQuery(ctx context.Context, in *SortQueryReq, opts ...grpc.CallOption) (*SortQueryResp, error) {
	...
	err := c.cc.Invoke(ctx, "/openim.user.user/sortQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) SetUserOnlineStatus(ctx context.Context, in *SetUserOnlineStatusReq, opts ...grpc.CallOption) (*SetUserOnlineStatusResp, error) {
	...
	err := c.cc.Invoke(ctx, "/openim.user.user/setUserOnlineStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) GetAllOnlineUsers(ctx context.Context, in *GetAllOnlineUsersReq, opts ...grpc.CallOption) (*GetAllOnlineUsersResp, error) {
	...
	err := c.cc.Invoke(ctx, "/openim.user.user/getAllOnlineUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_SortQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/openim.user.user/SortQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_SetUserOnlineStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/openim.user.user/SetUserOnlineStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_GetAllOnlineUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/openim.user.user/GetAllOnlineUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
